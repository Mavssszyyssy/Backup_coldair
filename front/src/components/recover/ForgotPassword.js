...
function ForgotPassword() {
  ...
  const resetPassword = async (event) => {
    ...
    if (!isStrongPassword(password)) { setError('Use at least 8 characters with uppercase, lowercase, number, and special character.'); return; }

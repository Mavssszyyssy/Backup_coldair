export const serviceLabel = (value) => ({
  regular_cleaning: "Regular cleaning", deep_cleaning: "Deep cleaning", installation: "Installation", repair: "Repair", inspection: "Inspection", warranty_claim: "Warranty claim",
...
export const serviceDetails = (service = {}) => [service.findings || service.details || service.summary, service.actionTaken].filter(Boolean).join(" · ") || "Detailed findings and actions were not recorded.";

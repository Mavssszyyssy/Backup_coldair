...
test('technician signs in, replaces initial password, and reaches work without authenticator setup', async () => {
  ...
  await fireEvent.changeText(screen.getByLabelText('New Password'), 'StrongPass123!');
  ...
  expect(api.completeTechnicianOnboarding).toHaveBeenCalledWith('fixture-token', { phone: '09123456789', newPassword: 'StrongPass123!' });

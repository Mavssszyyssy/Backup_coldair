...
export default function CompleteServiceScreen() {
  ...
  const formError = installationTask
    ? !canComplete
      ? "Scan each assigned QR or enter its serial number before completing this installation."
